'
'	  ______ ____   _____   _  _     ________   _______ ______ _      
'	 |  ____/ __ \ / ____| | || |   |  ____\ \ / / ____|  ____| |     
'	 | |__ | |  | | (___   | || |_  | |__   \ V / |    | |__  | |     
'	 |  __|| |  | |\___ \  |__   _| |  __|   > <| |    |  __| | |     
'	 | |___| |__| |____) |    | |   | |____ / . \ |____| |____| |____ 
'	 |______\____/|_____/     |_|   |______/_/ \_\_____|______|______|
'
'
'----------------------------------------------------------------------------------------
'
...
Function zeta_RKSmix(x As Variant, NC As Integer, Tc As Variant, pc As Variant, w As Variant, T As Double, pressure As Double, state As string) As Double
    Dim amix As Double
    Dim bmix As Double
    Dim a As Double
    Dim b As Double
